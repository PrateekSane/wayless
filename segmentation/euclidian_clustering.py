...
if __name__ == "__main__":
    ...
    file_ = '1753661088.959727526.pcd'
    process_pcd = ProcessPointCloud(pcd_file=file_ ,nrows_value=6000, display_output_flag=False)
    clusters = process_pcd.euclidean_clustering(distance_threshold=5, cluster_parameters={"min_size":2})
    # print(clusters)
    process_pcd.visualize_clusters(clusters)