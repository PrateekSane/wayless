    ...
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
        <div className="inline-flex items-center gap-2 bg-secondary/50 backdrop-blur-sm border border-border/50 rounded-full px-4 py-2 mb-8">
          ...
          <span className="text-sm text-muted-foreground">Next-generation AV data platform</span>
        </div>
        ...
        <p className="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
          Revolutionary data infrastructure for autonomous vehicle development. 
